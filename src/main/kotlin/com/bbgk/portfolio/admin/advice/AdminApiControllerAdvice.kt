package com.bbgk.portfolio.admin.advice

import com.bbgk.portfolio.admin.exception.AdminException
...
class AdminApiControllerAdvice {
    ...
    fun handleException(e: Exception): ResponseEntity<String> {
        log.info(e.message, e)
        return ResponseEntity.internalServerError().body("예기치 못한 시스템 오류가 발생했습니다.")
    }
}