package com.bbgk.portfolio.admin.context.introduction.controller

import com.bbgk.portfolio.admin.context.introduction.form.IntroductionForm
import com.bbgk.portfolio.admin.context.introduction.service.AdminIntroductionService
...
class AdminIntroductionApiController(
    ...
    @PutMapping("/{id}")
    fun postIntroduction(@PathVariable id: Long, @RequestBody @Validated form: IntroductionForm): ResponseEntity<Any> {
